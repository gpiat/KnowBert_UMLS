{
    "vocabulary": {
        "directory_path": "/data/dataset/knowbert/vocabulary_wiki.tar.gz",
    },
    ...
    "dataset_reader": {
        ...
        "dataset_readers": {
            ...
            "entity_linking": {
                ...
                // this is not in original code. Normally the AIDA LinkingReader creates its own
                // WikiCandidateMentionGenerator with default parameters. These default parameters
                // include URLS, which we replace here since the computing cluster is not connected
                // to the internet.
                "mention_generator": {
                    "type": "wiki",
                    "candidates_file": "resources/prob_yago_crosswikis_wikipedia_p_e_m.txt",
    ...
    "train_data_path": {
        ...
        "entity_linking": "/data/dataset/knowbert/aida_train.txt",
    },

    "model": {
        "type": "knowbert",
        "bert_model_name": "bert-base-uncased",
        "model_archive": "models/wiki_kar_train/model.tar.gz",

...
{
    "vocabulary": {
        "directory_path": dir + "tests/fixtures/umls_vocab_stid/",
    ...
    "dataset_reader": {
        ...
        "mention_generator": {
            ...
            "cui_count_file": dir + "umls_data/stid_counts.json",
    ...
    "train_data_path": "/sscratch/gpiat/MedMentions/full/data/corpus_pubtator_train.txt",
    "validation_data_path": "/sscratch/gpiat/MedMentions/full/data/corpus_pubtator_dev.txt",
    ...
    "iterator": {
        ...
        "entity_indexer": {
            ...
            "tokenizer": {
                "type": "word",
                "word_splitter": {"type": "just_spaces"},
                //"word_splitter": {"type": "semtype_tokenifier"},
            },
            "namespace": "entity"
        },
            ...
            "umls": {
                ...
                "entity_linker": {
                    ...
                    "entity_embedding": {
                        ...
                        "embedding_dim": 50,
                        // includes STID embeddings
                        "pretrained_file": "/home/data/dataset/UMLS/UMLS_embeddings.gz",
                        //"pretrained_file": "/home/data/dataset/UMLS/UMLS_embeddings_withnull.csv",
                        "trainable": false,
                        "sparse": false
                    },
    ...
    "trainer": {
        ...
        "learning_rate_scheduler": {
            ...
            // "num_steps_per_epoch": 2470, //from wordnet
            "num_steps_per_epoch": 434 // from wikipedia
        },

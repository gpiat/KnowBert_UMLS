...
{
    "vocabulary": {
        "directory_path": "/data/dataset/knowbert/vocabulary_wordnet_wiki.tar.gz"
    },
    ...
    "dataset_reader": {
        ...
        "dataset_readers": {
                    ...
                    "tokenizer_and_candidate_generator": {
                        ...
                        "entity_candidate_generators": {
                            "wordnet": {"type": "wordnet_mention_generator",
                                        "entity_file": "/data/dataset/knowbert/entities.jsonl"},
                            "wiki": {
                                "type": "wiki",
                                "candidates_file": "resources/prob_yago_crosswikis_wikipedia_p_e_m.txt",
                                "entity_world_path": "resources/wiki_id_to_string.json"
                            },
                        },
                        "entity_indexers":  {
                            "wordnet": {
            ...
            "wordnet_entity_linking": {
                ...
                "wordnet_entity_file": "/data/dataset/knowbert/entities.jsonl",
                "token_indexers": {
                    "tokens": {
            ...
            "wiki_entity_linking": {
                ...
                "should_remap_span_indices": false,
                // TODO: should the "mention_generator arg be in here?
                "mention_generator": {
                    "type": "wiki",
                    "candidates_file": "resources/prob_yago_crosswikis_wikipedia_p_e_m.txt",
                    "entity_world_path": "resources/wiki_id_to_string.json",
    ...
    "train_data_path": {
        "language_modeling": "/data/dataset/knowbert/kb_retrain_nsp_mlm/shard_{00..19}.txt",
        "wordnet_entity_linking": "/data/dataset/knowbert/semcor_and_wordnet_examples.json",
        "wiki_entity_linking": "/data/dataset/knowbert/aida_train.txt",
    },

    "model": {
        "type": "knowbert",
        "bert_model_name": "bert-base-uncased",
        "model_archive":  "models/wordnet_wiki_kar_train/model.tar.gz",
            ...
            "wordnet": {
                ...
                "entity_linker": {
                    ...
                    "concat_entity_embedder": {
                        ...
                        "entity_file": "/data/dataset/knowbert/entities.jsonl",
                        "embedding_file": "/data/dataset/knowbert/wordnet_synsets_mask_null_vocab_embeddings_tucker_gensen.hdf5",
                        "vocab_file": "/data/dataset/knowbert/wordnet_synsets_mask_null_vocab.txt",
                        "entity_dim": 200,
            ...
            "wiki": {
                ...
                "entity_linker": {
                    ...
                    "entity_embedding": {
                        ...
                        "embedding_dim": 300,
                        "pretrained_file": "/data/dataset/knowbert/entities_glove_format.gz",
                        "trainable": false,
                        "sparse": false
                    },
                    "contextual_embedding_dim": 768,

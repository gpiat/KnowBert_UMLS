...
local weight_decay = 0.02;

{
    "dataset_reader": {
        "type": "chemprot_relex_reader",
    ...
    "model": {
        ...
        "model": {
            ...
            "archive_file": "umls_data/16_percent_data/2022_07_24_maxprior/model.tar.gz",
        },
        "bert_dim": 768,
    ...
    "train_data_path": "/home/data/dataset/ChemProt/BLUE_unmasked/train.tsv",
    "validation_data_path": "/home/data/dataset/ChemProt/BLUE_unmasked/dev.tsv",
    "test_data_path": "/home/data/dataset/ChemProt/BLUE_unmasked/test.tsv",
    "trainer": {
        "cuda_device": 0,
        ...
        "learning_rate_scheduler": {
            ...
            "num_steps_per_epoch": 19461 / batch_size
        },
        "num_epochs": num_epochs,
